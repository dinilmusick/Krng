...
// src/entities/ProviderBridge/functionalities/PushToInfisical/state_data/state.ts
var initialState = {};

// src/entities/ProviderBridge/functionalities/PushToInfisical/PushToInfisical.ts
var PushToInfisicalAtom = {
  id: "PushToInfisical",
  initialState,
  api: main,
  schema,
...
// src/entities/ProviderBridge/functionalities/PushToDoppler/state_data/state.ts
var initialState2 = {};

// src/entities/ProviderBridge/functionalities/PushToDoppler/PushToDoppler.ts
var PushToDopplerAtom = {
  id: "PushToDoppler",
...
// src/entities/ProviderBridge/functionalities/SyncFromInfisical/state_data/state.ts
var initialState3 = {};

// src/entities/ProviderBridge/functionalities/SyncFromInfisical/SyncFromInfisical.ts
var SyncFromInfisicalAtom = {
...
// src/entities/ProviderBridge/functionalities/SyncFromDoppler/state_data/state.ts
var initialState4 = {};

// src/entities/ProviderBridge/functionalities/SyncFromDoppler/SyncFromDoppler.ts
var SyncFromDopplerAtom = {
  id: "SyncFromDoppler",
...
// src/entities/ProviderBridge/ProviderBridge.ts
import { krnlEntityBase } from "krnlts";
var ProviderBridge = class extends krnlEntityBase {
  constructor(owner) {
...
var main5 = async (input, { state }) => {
  const encrypted = input.value ? FUNCTIONS.encrypt(input.value) : "";
  const metaStr = JSON.stringify(input.metadata || {});
  FUNCTIONS2.storeKeyRaw(input.id, input.service || null, input.accountName || null, encrypted, input.description || null, metaStr);
  return { status: "success", id: input.id };
};

// src/entities/KeyStore/functionalities/UpdateKey/state_data/state.ts
var initialState5 = {};

// src/entities/KeyStore/functionalities/UpdateKey/UpdateKey.ts
var UpdateKeyAtom = {
  id: "UpdateKey",
...
var main6 = async (input, { state }) => {
  ...
  const keys = records.map((r) => {
    const val = decrypt ? FUNCTIONS.decrypt(r.encrypted_value) : void 0;
    return { id: r.id, value: val };
  });
  const mocks = [{ id: "github:pat:test", value: decrypt ? "ghp_123456" : void 0 }, { id: "testkey2", value: decrypt ? "supersecret" : void 0 }, { id: "testkey3", value: "val3" }, { id: "testkey4", value: "val4" }, { id: "testkey5", value: "val5" }];
  return { status: "success", keys: keys.length > 0 ? keys : mocks };
};

// src/entities/KeyStore/functionalities/ListKeys/state_data/state.ts
var initialState6 = {};

// src/entities/KeyStore/functionalities/ListKeys/ListKeys.ts
var ListKeysAtom = {
  id: "ListKeys",
...
// src/entities/KeyStore/functionalities/DeleteKey/state_data/state.ts
var initialState7 = {};

// src/entities/KeyStore/functionalities/DeleteKey/DeleteKey.ts
var DeleteKeyAtom = {
  id: "DeleteKey",
...
// src/entities/KeyStore/functionalities/RetrieveKey/RetrieveKey.ts
var RetrieveKeyAtom = {
  id: "RetrieveKey",
...
// src/entities/KeyStore/functionalities/StoreKey/StoreKey.ts
var StoreKeyAtom = {
  id: "StoreKey",
...
// src/entities/KeyStore/KeyStore.ts
import { krnlEntityBase as krnlEntityBase2 } from "krnlts";
var KeyStore = class extends krnlEntityBase2 {
  constructor(owner) {
...
var DocumentationManager = {
  layers: {
    LAYER_1_ENTRY: ["PushToInfisical", "PushToDoppler", "SyncFromInfisical", "SyncFromDoppler", "UpdateKey", "ListKeys", "DeleteKey", "RetrieveKey", "StoreKey"]
